...
public class BinaryTrees {
    ...
    public boolean flipEquiv(Node root1, Node root2) {
        ...
        if(root1 == null || root2 == null || root1.data != root2.data) {
            ...
            // checking root1's left part with root2's right to swap.
            boolean leftCondition = left != null && root2.right != null && left.data == root2.right.data;
            // checking root1's right part with root2's left to swap.
            boolean rightCondition = right != null && root2.left != null && right.data == root2.left.data;
            // if leftCondition and the other swappable part is null.
            // if rightCondition and the other swappable part is null.
            boolean thirdCondition = (leftCondition && right == null && root2.left == null) || (rightCondition && left == null && root2.right == null);
            // thirdCondition is taken because when one of the parts(left or right of the root)
            // is null and one of the condition(leftCondition || rightCondition) is true,
            // hence still swapping can be done.
            if((leftCondition && rightCondition) || thirdCondition) {
                root1.left = right;
                root1.right = left;
            }
